...
export const Footer: React.FC<FooterProps> = ({ active, onNavClick }) => {
  return (
    <div className="fixed bottom-0 left-0 w-full rounded-t-xl border-y-2 border-neutral-200 dark:border-neutral-500 bg-background backdrop-blur-md z-50">
