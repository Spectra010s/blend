      ...
      <div className="flex justify-center">
        <div className="flex flex-col gap-8 items-center w-full max-w-md">
          ...
          <div className="flex flex-wrap justify-center gap-25">
            <NumberPicker numbers={hours} value={hour} setValue={setHour} label="Hours" disabled={isRunning} />
            <NumberPicker numbers={minutes} value={min} setValue={setMin} label="Mins" disabled={isRunning} />
            <NumberPicker numbers={seconds} value={sec} setValue={setSec} label="Secs" disabled={isRunning} />
          </div>
