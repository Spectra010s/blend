  ...
  return (
    <main className="h-screen w-full flex flex-col relative border-x border-x-bg-black dark:border-x-bg-white">
      ...
      <div className="flex mt-4 p-4 gap-2">
        ...
        />
        <button
          className="px-4 py-1 bg-gray-800 text-white hover:bg-gray-700 transition-all duration-300 rounded"
          onClick={addTodo}
        >
          Add
        </button>
      ...
      <ul className="mt-3 pb-20 flex-1 p-5 overflow-y-auto [overscroll-behavior:contain] [scroll-behavior:smooth]">
        {todos.map(todo => (
          <li
            key={todo.id}
